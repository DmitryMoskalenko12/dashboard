  ...
  return (
    <aside className="aside">
      <div className="aside__wrapper">
        <div className="aside__logo-block">
          <img
            ...
            height={39}
          />
          <span className="aside__logo-version">v.01</span>
        </div>
        <nav className="aside__nav">
          <ul className="aside__nav-list">
            <li className="aside-item">
              <div className="aside-item__sub-block">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span className="aside-item__text">Dashboard</span>
              </div>
              <svg
                width="16"
                height="16"
            ...
            <li className="aside-item">
              <div className="aside-item__sub-block">
                ...
                <span className="aside-item__text">Product</span>
              </div>
              <svg
                width="16"
                height="16"
            ...
            <li>
              <button className="aside-item aside-item_active">
                <div className="aside-item__sub-block">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  <span className="aside-item__text aside-item__text_active">
                    Customers
                  </span>
                </div>
                <svg
            ...
            <li className="aside-item">
              <div className="aside-item__sub-block">
                ...
                <span className="aside-item__text">Income</span>
              </div>
              <svg
                width="16"
                height="16"
            ...
            <li className="aside-item">
              <div className="aside-item__sub-block">
                ...
                <span className="aside-item__text">Promote</span>
              </div>
              <svg
                width="16"
                height="16"
            ...
            <li className="aside-item">
              <div className="aside-item__sub-block">
                ...
                <span className="aside-item__text">Help</span>
              </div>
              <svg
                width="16"
                height="16"
      ...
      <div className="aside__evano-block">
        <img
          className="aside__evano-img"
          src={avatar}
          alt="avatar"
          width={42}
          height={42}
        />
        <div className="aside__evano-text-block">
          <span className="aside__evano">Evano</span>
          <span className="aside__job-title">Project Manager</span>
        </div>
      </div>
    </aside>
  );
